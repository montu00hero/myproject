<?php
	...
	define('APP_ID', '1230243760375594');
	define('APP_SECRET', '2adb08f5067b35e41cbbcaae78339347');
	define('REDIRECT_URL','http://jbmall.in/FacebookLoginPHP/');
...
<html>
	...
	*/
	...
	if(isset($sess)){
		...
		$request  = new FacebookRequest($sess, 'GET', '/me?locale=en_US&fields=id,name,email,picture');
